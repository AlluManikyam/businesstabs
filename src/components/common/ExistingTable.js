...
class ExistingTable extends Component {
  constructor(props) {
    super(props);
    this.state = {
      text: "",
      tbName: "",
      tableData: global.FindExistingCaseArray,
      row: false,
      loading: true,
      selected: []
    };
...
ExistingTable.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withRouter(ExistingTable);
